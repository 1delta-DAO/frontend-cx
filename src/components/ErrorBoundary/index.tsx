...
const IS_ONE_DELTA = window.location.hostname === '1delta.io'
                ...
                <AutoRow>
                  <LinkWrapper>
                    <ExternalLink
                      ...
                      href={`https://github.com/1delta-DAO/frontend/issues/new?assignees=&labels=bug&body=${encodedBody}&title=${encodeURIComponent(
