...
const FacuetLabel = ({ chainId }: { chainId: SupportedChainId }) => {
  switch (chainId) {
    case SupportedChainId.ARBITRUM_RINKEBY:
      return <Trans>Arbitrum Facuet</Trans>
    case SupportedChainId.OPTIMISM_GOERLI:
      return <Trans>Optimism Facuet</Trans>
    case SupportedChainId.POLYGON_MUMBAI:
      return <Trans>Mumbai Faucet</Trans>
    case SupportedChainId.CELO_ALFAJORES:
      return <Trans>Portal Faucet</Trans>
    default:
...
function Row({
  ...
  const { helpCenterUrl, explorer, bridge, label, logoUrl, faucet } = getChainInfo(targetChain)
...
export default function NetworkSelector() {
  ...
  const info = !provider ? undefined : getRawChainInfo(chainId)
