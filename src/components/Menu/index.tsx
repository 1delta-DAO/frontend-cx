...
export default function Menu() {
  ...
  const showDELTAClaimOption = Boolean(!!account && !!chainId && !L2_CHAIN_IDS.includes(chainId))
          ...
          (() => {
            switch (menu) {
              ...
              default:
                return (
                  <MenuFlyout>
                    <MenuItem href="https://1delta.io/">
                      <div>
                        <Trans>About</Trans>
                      </div>
                      <Info opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://help.1delta.io/">
                      <div>
                        <Trans>Help Center</Trans>
                      </div>
                      <HelpCircle opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://1delta.canny.io/feature-requests">
                      <div>
                    ...
                    <MenuItem href="https://docs.1delta.io/">
                      <div>
                        <Trans>Docs</Trans>
                      </div>
