  ...
  },
  {
    ...
    description: (
      <>
        ...
        <ExternalLink href="https://API_URL">
    ...
    >
      <AutoColumn gap="16px">
        <AutoColumn gap="8px" style={{ width: '100%' }}>
          <StyledExternalCard>
            <ExternalLink href={'https://1delta.io/terms-of-service'}>
              <RowBetween>
                <AutoRow gap="4px">
                  <Info size={20} />
                  <ThemedText.DeprecatedMain fontSize={14} color={'deprecated_primaryText1'}>
                    <Trans>1delta Labs&apos; Terms of Service</Trans>
          ...
          <StyledExternalCard>
            <ExternalLink href={'https://1delta.io/disclaimer/'}>
              <RowBetween>
                <AutoRow gap="4px">
                  <Info size={20} />
                  <ThemedText.DeprecatedMain fontSize={14} color={'deprecated_primaryText1'}>
        ...
        <AutoColumn gap="12px">
          ...
          <ThemedText.DeprecatedBody fontSize={12}>
            <Row justify="center" marginBottom="1rem">
              <ExternalLink href="https://help.1delta.io/en/articles/5675203-terms-of-service-faq">
                <Trans>Learn more</Trans>
              </ExternalLink>
            </Row>
