      ...
      return redesignFlagEnabled ? (
        <AutoRow style={{ flexWrap: 'nowrap', padding: '4px 16px' }}>
          <ThemedText.BodySecondary fontSize={12}>
            <Trans>
              By connecting a wallet, you agree to 1delta{' '}
              <ExternalLink href="https://API_URL/terms-of-service/">Terms of Service</ExternalLink> and acknowledge
              that you have read and understand the 1Delta{' '}
              <ExternalLink href="https://API_URL/disclaimer/">Protocol Disclaimer</ExternalLink>.
            </Trans>
        ...
        <LightCard>
          <AutoRow style={{ flexWrap: 'nowrap' }}>
            <ThemedText.DeprecatedBody fontSize={12}>
              <Trans>
                By connecting a wallet, you agree to 1delta’{' '}
                <ExternalLink style={{ textDecoration: 'underline' }} href="https://API_URL/terms-of-service/">
                  Terms of Service
                </ExternalLink>{' '}
                and acknowledge that you have read and understand the 1Delta{' '}
                <ExternalLink style={{ textDecoration: 'underline' }} href="https://API_URL/disclaimer/">
                  Protocol Disclaimer
                </ExternalLink>
                .
              </Trans>
