...
import { useCompoundLiquidationThreshold, useLiquidationThreshold } from 'state/1delta/hooks'
...
export function YieldDetailsMarginTrade({
  ...
  const [bLiq] = useCompoundLiquidationThreshold([assetCollateral], chainId)
