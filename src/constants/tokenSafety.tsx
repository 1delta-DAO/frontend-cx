...
export const TOKEN_SAFETY_ARTICLE = 'https://API_URL'
  ...
  if (warning) {
    if (warning.canProceed) {
      ...
      description = (
        <Plural
          value={plural ? 2 : 1}
          _1="You can't trade this token using the 1delta App."
          other="You can't trade these tokens using the 1delta App."
        />
      )
    }
  }
