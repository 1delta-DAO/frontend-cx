...
import { useV3SwapPoolsMoneyMarket } from './useV3SwapPools'
 ...
 */
export function useAllV3RoutesMoneyMarket(
  currencyIn?: Currency,
  currencyOut?: Currency
): { loading: boolean; routes: Route<Currency, Currency>[] } {
  const chainId = useChainId()
  const { pools, loading: poolsLoading } = useV3SwapPoolsMoneyMarket(currencyIn, currencyOut)
