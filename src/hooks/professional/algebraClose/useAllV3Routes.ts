...
import { useAlgebraSwapPools } from './useV3SwapPools'
 ...
 */
export function useAllV3RoutesAlgebra(
  currencyIn?: Currency,
  currencyOut?: Currency
): { loading: boolean; routes: Route<Currency, Currency>[] } {
  const chainId = useChainId()

  const { pools, loading: poolsLoading } = useAlgebraSwapPools(currencyIn, currencyOut)
