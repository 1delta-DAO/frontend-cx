...
import { useV3SwapPoolsProfessional } from './useV3SwapPools'
 ...
 */
export function useAllV3RoutesProfessional(
  currencyIn?: Currency,
  currencyOut?: Currency
): { loading: boolean; routes: Route<Currency, Currency>[] } {
  const chainId = useChainId()

  const { pools, loading: poolsLoading } = useV3SwapPoolsProfessional(currencyIn, currencyOut)
