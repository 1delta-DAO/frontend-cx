 ...
 */
export function useClientSideV3Professional<TTradeType extends TradeType>(
  ...
  const { routes: fetchedRoutes, loading: routesLoading } = useAllV3RoutesProfessional(currencyIn, currencyOut)
