...
import { useAllV3RoutesMarginTrade } from './useAllV3Routes'
 ...
 */
export function useClientSideV3MarginTrade<TTradeType extends TradeType>(
  ...
  const { routes: fetchedRoutes, loading: routesLoading } = useAllV3RoutesMarginTrade(currencyIn, currencyOut)
