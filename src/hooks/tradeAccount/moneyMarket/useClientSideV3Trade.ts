 ...
 */
export function useClientSideV3MoneyMarket<TTradeType extends TradeType>(
  ...
  const { routes: fetchedRoutes, loading: routesLoading } = useAllV3RoutesMoneyMarket(currencyIn, currencyOut)
