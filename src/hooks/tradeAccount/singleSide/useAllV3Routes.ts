...
import { useV3SwapPoolsSingleSide } from './useV3SwapPools'
 ...
 */
export function useAllV3RoutesSingleSide(
  currencyIn?: Currency,
  currencyOut?: Currency
): { loading: boolean; routes: Route<Currency, Currency>[] } {
  const chainId = useChainId()
  const { pools, loading: poolsLoading } = useV3SwapPoolsSingleSide(currencyIn, currencyOut)
