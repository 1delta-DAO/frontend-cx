...
import { useAllV3RoutesSingleSide } from './useAllV3Routes'
 ...
 */
export function useClientSideV3SingleSide<TTradeType extends TradeType>(
  ...
  const { routes: fetchedRoutes, loading: routesLoading } = useAllV3RoutesSingleSide(currencyIn, currencyOut)
