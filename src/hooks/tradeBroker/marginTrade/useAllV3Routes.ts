...
import { useV3SwapPoolsMarginTrade } from './useV3SwapPools'
 ...
 */
export function useAllV3RoutesMarginTrade(
  currencyIn?: Currency,
  currencyOut?: Currency
): { loading: boolean; routes: Route<Currency, Currency>[] } {
  const chainId = useChainId()
  const { pools, loading: poolsLoading } = useV3SwapPoolsMarginTrade(currencyIn, currencyOut)
