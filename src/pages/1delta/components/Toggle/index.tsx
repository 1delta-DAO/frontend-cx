import { ToggleContainer } from 'components/Styles/tableStyles'
import Loader from 'components/Loader'
import { ToggleShell } from 'components/Toggle'
...
interface ToggleComponentProps {
  ...
  isToggled: boolean
  handleCollateralConfig: () => void
}

export const ToggleComponent = ({ transactionSubmitted, isToggled, handleCollateralConfig }: ToggleComponentProps) => {

  return <ToggleContainer>
    {transactionSubmitted ?
      <ToggleShell isActive={isToggled}>
        <Loader />
      </ToggleShell>
      :
