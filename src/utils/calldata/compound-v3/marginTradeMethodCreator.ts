...
import { CometMarginTrader, CometSweeper, MarginTrader, Sweeper } from 'abis/types'
...
export const createMarginTradeCalldataComet = (
...
export const createMarginTradeCalldataFromTradeComet = (
  trade: UniswapTrade | undefined,
  allowedSlippage: Percent,
  marginTraderContract: CometMarginTrader & CometSweeper,
  ...
  if (trade.routes.length === 1) return createMarginTradeCalldataComet(
    trade,
    allowedSlippage,
